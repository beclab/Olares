...
1. 从应用坞或启动台，打开**应用市场**。
2. 找到目标应用，双击查看其详情。
3. （可选）如果该应用支持多种硬件加速器，在**资源**区域配置部署信息：
    ...
    b. 查看动态更新后的 **CPU**、**Memory**、**Required disk** 和 **VRAM** 要求，确保你的硬件满足这些条件。

4. 点击**获取**。
5. 当操作按钮变为**安装**时，点击开始安装。
6. （可选）若要取消安装，点击按钮右侧的 <i class="material-symbols-outlined">close_small</i>。
7. 安装完成后，按钮将变为**打开**。
