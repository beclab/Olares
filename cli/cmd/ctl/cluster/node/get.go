...
func renderGetTable(n Node) error {
	...
	fmt.Fprintf(w, "Container Runtime:\t%s\n", clusteropts.DashIfEmpty(n.Status.NodeInfo.ContainerRuntimeVersion))
	fmt.Fprintf(w, "OS Image:\t%s\n", clusteropts.DashIfEmpty(n.Status.NodeInfo.OSImage))
	fmt.Fprintf(w, "Kernel:\t%s\n", clusteropts.DashIfEmpty(n.Status.NodeInfo.KernelVersion))
	fmt.Fprintf(w, "Architecture:\t%s\n", clusteropts.DashIfEmpty(n.Status.NodeInfo.Architecture))
	fmt.Fprintf(w, "Created:\t%s\n", clusteropts.DashIfEmpty(n.Metadata.CreationTimestamp))
	fmt.Fprintf(w, "Age:\t%s\n", n.Age(time.Now()))
