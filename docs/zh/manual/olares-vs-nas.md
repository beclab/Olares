...
| Linux         | 通过容器化工作负载支持                               | 通过 ISO 安装                  | 通过 ISO 安装 |
...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ------ |
| GPU 管理 | 1. 支持多节点下的异构 GPU 集群（1.12 版本） <br/>2. NVIDIA 显卡支持容量分片、<br/>分时共享两种显卡共享模式（1.12 版本）                                                            | 单节点下通过手工方式<br/>支持显卡直通 | ❌ |
