...
connectionLatestPath: /use-cases/openwebui-knowledge
noindex: true
search: false
outline: deep
title: Chat with documents in Open WebUI — Olares 1.12.6
...
# Chat with documents and knowledge bases in Open WebUI — Olares 1.12.6
