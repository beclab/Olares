      ...
      items: [
        {
          ...
          collapsed: true,
          items: [
            { text: "Installation architecture", link: "/developer/install/installation-overview" },
            { text: "Installation process",      link: "/developer/install/installation-process" },
            { text: "Olares Home",               link: "/developer/install/olares-home" },
            { text: "Environment variables",     link: "/developer/install/environment-variables" },
            { text: "Olares versioning",         link: "/developer/install/versioning" },
            // {
            ...
            //     { text: "status", link: "/developer/install/cli/status" },
