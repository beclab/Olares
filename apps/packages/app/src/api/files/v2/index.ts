...
import ShareAPI from './share/base/data';
import PublicShareAPI from './share/external';
// import ShareByMeAPI from './share/by_me';
...
class DriveAPI {
	...
	> = {
		...
		[DriveType.Share]: ShareAPI,
		[DriveType.PublicShare]: PublicShareAPI
	};
