...
const options_update = {
	PROGRESS_WAIT: 'Critical processes are in progress. Please wait...',
...
const options = {
	...
	CLUSTER_ADVANCED_SETTINGS_DESC:
		'You can configure the services based on your needs.',
	...
	CLUSTER_ETCD_BACKUP_PERIOD_DESC:
		'Period of running backup etcd job in minutes.',
	...
	MASTER_NODE_COUNT_TIP: 'The number of master nodes must be 1 or 3',
	WORKER_NODE_COUNT_TIP: 'The number of worker nodes must be at least 1',
	...
	ETCD_BACKUP_DIR: 'etcd backup directory',
	...
	MODIFY_MEMBER_ROLE: 'Modify Mmember role',
	...
	CATEGORY_NAME_DESC:
		'The name can contain any characters, with a maximum length of 20 characters.',
	...
	REJECT: 'Reject',
	REJECT_REASON_DESC: 'Enter the reason for rejecting the app.',
	...
	APP_REVIEW_EMPTY_DESC:
		'Please create an app template in a workspace and submit it for review.',
	...
	OPERATOR: 'Operator',
	APP_REVIEW_UNPROCESSED_EMPTY_DESC: 'No app to review',
	SUSPEND: 'Suspend',
	APP_NOTE: 'Note',
	...
	SUCCESS_THRESHOLD_DESC:
		'Number of consecutive successes required for the probe to be marked as successful after a failure. The value must be at least 1, and exactly 1 for liveness and startup probes.',
	FAILURE_THRESHOLD_DESC:
		'Number of consecutive failures before the probe is marked as failed, after a previous success. The value must be at least 1.',
	PROBE_COMMAND_EMPTY: 'Please enter at least one command.',
	TCP_PORT: 'TCP port',
	MOUNT_PATH_IN_USE:
		'The mount path is already in use. Please enter another one.',
	CREATOR: 'Creator',
	NO: 'No',
	EDIT_CONTAINER: 'Edit container',
	MULTI_CLUSTER_RESOURCE_TIP:
		'The current resource is deployed across multiple clusters. Click a cluster to view its settings.',
	NODE: 'Node',
	...
	FEDPROJECT_RESOURCE_TIP:
		'To create workloads in a multi-cluster project, go to its Workloads page.',
	FINISHED: 'Done',
	NOT_SET: 'To do',
	CURRENT: 'Current',
	PROJECT: 'Project',
	...
	SPECIFY_SUBPATH_TIP:
		'Specify a volume subpath to mount inside the container.',
	...
	MOUNT_PATH_REPEATED: 'Duplicate mount path.',
	...
	NO_GATEWAY_DESC:
		'To use Auto Generate, please contact the project administrator to configure the gateway access mode in Gateway Settings of the project.',
	PATH: 'Path',
	PROTOCOL: 'Protocol',
	PORT: 'Port',
	...
	SERVICE_PL: 'Services',
	SERVICE_DESC:
		'Services provide an abstract way to expose applications running in pods as network services.',
	...
	LOG_COLLECTION_ENABLE_TIPS:
		'The new status requires about one minute to take effect.',
	...
	SERVICE_ADDRESS_EXIST:
		'The service address already exists. Please enter a new one.',
	...
	APPLICABLE_SCENE: 'Applicable sScenario',
	...
	DISPLAY_FORMAT: 'Display Fformat',
	...
	NETWORK_POLICY_DESC:
		'The network policy configuration allows network isolation within the same cluster. This means firewalls can be set up between certain instances (pods).',
	...
	NO_MATCHING_RESULT_FOUND: 'No matching results found',
	STATUS: 'Status',
	...
	EDGENODE_CONFIG_COMMAND: 'Edge mode configuration command',
	...
	AVAILABLE_QUOTAS: 'Quota available',
	...
	POD_SECURITY_CONTEXT_TIP:
		'If Uuser, user group, and SELinux context settings are defined in both pod Security Context and Container Security Context, the Container Security Context settings will override the Pod Security Context settings.',
	...
	RESOURC_QUOTAS_UNSET: 'Resource ouotas unset',
	...
	PVC_OR_TEMPLATE_EMPTY:
		'You have enabled log collection on volumes. Please add at least one persistent volume, temperary volume, or persistent volume claim template and specify the path of container logs.',
	PVC_EMPTY:
		'You have enabled log collection on volumes. Please add at least one persistent volume or temperary volume and specify the path of container logs.',
	PROJECT_COLLECT_SAVED_DISABLED_DESC:
		'To enable this function, you need to enable log collection on volumes in Project settings.',
	...
	SERVICE_TYPE_EXTERNALSERVICE: 'External srvice',
	HEADLESS: 'Headless',
