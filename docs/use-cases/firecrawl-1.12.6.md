...
# Use Firecrawl as a web page loader — Olares 1.12.6
...
To use Firecrawl in Open WebUI, first [connect Open WebUI to a model](openwebui-1.12.6.md#configure-model-backend) and configure web search. The [Open WebUI web search guide](openwebui-search-1.12.6.md#enable-web-search-1) uses SearXNG as one example. Then manually configure Firecrawl as the web page loader below.
...
- [Enable web search in Open WebUI](openwebui-search-1.12.6.md): Configure SearXNG and web search in Open WebUI.
