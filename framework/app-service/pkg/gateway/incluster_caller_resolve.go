...
//
// requirement: extraction contract. Extracted byte-equal from the
...
// applied here -- the "primary ref" determinism contract is
// delivered alongside its actual use site.
//
// requirement: extraction contract. Extracted byte-equal from the
