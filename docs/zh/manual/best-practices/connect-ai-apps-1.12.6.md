...
- [使用 LobeHub 构建本地 AI Agent](/zh/use-cases/lobechat-1.12.6.md)
- [使用 Open WebUI 搭建本地 AI 对话界面](/zh/use-cases/openwebui-1.12.6.md)
- [使用 Dify 定制本地 AI 助手](/zh/use-cases/dify-1.12.6.md)

## 了解更多

- [AI 应用之间是如何连接的？](../help/usage.md#ai-应用之间是如何连接的)
- [使用 Ollama、vLLM、llama.cpp 和 SGLang 运行本地大模型](/zh/use-cases/llm-base-apps-1.12.6.md)
