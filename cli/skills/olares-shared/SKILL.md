...
| [`olares-download`](../olares-download/SKILL.md) | Download-server task centre (create / list / pause / resume / cancel / remove / inspect / prefs); Settings `/download` edge; Olares >= 1.12.7 | managing URL/yt-dlp/aria2 download *tasks* (not `files download`) |
