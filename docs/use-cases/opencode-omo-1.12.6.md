...
search: false
outline: [2, 3]
title: Run multi-agent workflows with oh-my-openagent — Olares 1.12.6
...
# Orchestrate multi-agent workflows with oh-my-openagent — Olares 1.12.6
...
- [OpenCode installed](opencode-1.12.6.md) on Olares, chart version 1.0.6 or later.
- The following models:

  | Used for | Model | How to get it |
  | :--- | :--- | :--- |
  | Core agents | Qwen3.6-27B (llama.cpp) | Install from Market |
  | Lightweight subagents | Qwen3.5-9B (Ollama) | [Create with an Ollama Engine Base app](llm-base-apps-1.12.6.md#create-a-new-model-instance) |

Before configuring OMO, [connect both models to OpenCode](opencode-1.12.6.md#connect-to-a-custom-provider).
...
- [Set up OpenCode as your AI coding agent](opencode-1.12.6.md): Install OpenCode and connect it to Ollama.
