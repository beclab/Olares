<template>
	<ul style="height: 100%" v-if="items && items.length > 0">
		...
		>
			...
			>
				<div
					class="check-content row items-center check-content-wrapper full-width q-mb-lg"
					:class="{
						isSelect: deviceStore.isInEditor
					}"
				>
					<div
						...
						:class="{
							isSelect: deviceStore.isInEditor,
							'q-ml-lg': deviceStore.isInEditor
						}"
					>
						<img
...
import activeImage from 'src/assets/plugin/check_box.svg';
import normalImage from 'src/assets/plugin/uncheck_box_light.svg';
import normalDarkImage from 'src/assets/plugin/uncheck_box_dark.svg';
