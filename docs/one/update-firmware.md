...
|:--------|:-------------|:----------|
| [1.05 (Download)](http://cdn.olares.com/common/OlaresOne_BIOS_1.05.zip) | 2026-07-06 | <ul><li>Fix the Thunderbolt port issue by disabling the D3 (D3hot/D3cold) low-power state only for the GPU. Previously, D3 was disabled for all devices to address the abnormal power consumption issue.</li></ul> |
...
| Version | Release date | Changelog |
|:--------|:-------------|:----------|
| [1.03 (Download)](http://cdn.olares.com/common/OlaresOne_EC_1.03.zip) | 2026-05-29 | <ul><li>Add the port for automatic power-on after connecting the adapter, enabling the <strong>Automatic startup</strong> feature in Settings.</li><li>Require Olares OS 1.12.6 or later.</li></ul> |
