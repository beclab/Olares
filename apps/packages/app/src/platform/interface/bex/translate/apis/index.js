...
export const apiBaiduTTS = (text, lan = 'uk', spd = 3) => {
	...
	return fetchData(url, {
		useCache: false // Disable caching of voice data to avoid rapid cache growth
	});
};

/**
 * Tencent language detection
 * @param {*} text
 * @returns
 */
...
export const apiTranslate = async ({
	...
	// Version number first/second digit upgrade, old cache becomes invalid
	const [v1, v2] = REACT_APP_VERSION.split('.');
	const cacheOpts = {
		translator,
		text,
		fromLang,
