...
不过，连接显示器只是开始。由于 Steam Headless 默认针对远程串流做了优化，你需要手动配置显示和音频设置，才能在本机玩游戏。

:::tip Olares One 用户
Olares One 已预配置好显示和音频，无需手动设置。参见[在 Olares One 本机畅玩 Steam 游戏](../one/steam-direct-play.md)。
:::
