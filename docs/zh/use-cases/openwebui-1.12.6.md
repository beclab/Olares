...
:::warning
本文档由 AI 自动翻译，仅供参考。涉及关键操作或信息时，请以[英文原文](../../use-cases/openwebui-1.12.6.md)为准。
:::

# 设置 Open WebUI 与本地 AI 对话 — Olares 1.12.6
...
- [启用网页搜索](openwebui-search-1.12.6.md)：为聊天增加网页搜索能力。
- [使用知识库](openwebui-knowledge-1.12.6.md)：上传文档并创建用于 RAG 的知识库。
