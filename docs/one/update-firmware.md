...
|:--------|:-------------|:----------|
| [1.05 (Download)](http://cdn.olares.com/common/OlaresOne_BIOS_1.05.zip) | 2026-07-06 | <ul><li>Fix the Thunderbolt port issue by disabling the D3 low-power state only for the GPU. Previously, D3 was disabled for all devices to address abnormal power consumption.</li></ul> |
