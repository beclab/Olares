...
| `olares-model` | Configure and use AI models: add a cloud vendor's models, install a local model app, pick the defaults, issue keys and quotas, read usage, and call a model for chat, embeddings, transcription, speech, or OCR. |
