...
search: false
outline: [2, 3]
title: 使用 Engine Base 运行本地大模型 — Olares 1.12.6
...
:::warning
本文档由 AI 自动翻译，仅供参考。涉及关键操作或信息时，请以[英文原文](../../use-cases/llm-base-apps-1.12.6.md)为准。
:::

# 使用 Ollama、vLLM、llama.cpp 和 SGLang 运行本地大模型 — Olares 1.12.6
...
下面的示例以 [OpenCode](opencode-1.12.6.md) 作为客户端。
