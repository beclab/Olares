...
# Enable web search in Open WebUI — Olares 1.12.6
...
- [Open WebUI](openwebui-1.12.6.md) installed and configured with at least one connected local model.
- SearXNG installed.
...
<!--@include: ../reusables/ai-service-connections-1.12.6.md#get-embedding-model-connection-details-openai-->
...
3. Specify the following settings:
   ...
   - **Bypass Web Loader**: Enable this setting if you only need search result summaries. Leave it disabled if you want Open WebUI to fetch full page content through a web loader.
      ...
      For full-page retrieval, install Firecrawl and configure it as the web loader. See [Use Firecrawl as a web page loader](firecrawl-1.12.6.md#configure-open-webui).
      :::
