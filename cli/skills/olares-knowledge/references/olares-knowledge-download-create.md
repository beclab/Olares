# knowledge download: creating a task and following it

> **Flags:** `olares-cli knowledge download create|info|wait --help`. Managing tasks that already exist — listing, pausing, removing — is [task management](olares-knowledge-download-manage.md).
