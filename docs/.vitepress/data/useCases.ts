...
export const useCases: UseCase[] = [
  ...
  { title: "Jellyfin", link: "/use-cases/stream-media", category: "Entertainment", description: "Private media streaming server", descriptionZh: "私人流媒体服务器" },
  { title: "Steam", link: "/use-cases/play-games-directly", category: "Entertainment", description: "Play Steam games locally or stream them", descriptionZh: "本地游玩 Steam 游戏或串流到其他设备" },
