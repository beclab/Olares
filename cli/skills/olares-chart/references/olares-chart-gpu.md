...
Declaring GPU resources in the manifest (quantities, `nvidia` mode → arch cross-check) is covered in [olares-chart-manifest.md](olares-chart-manifest.md) (`spec.accelerator`) and [olares-chart-publish-targets.md](olares-chart-publish-targets.md).
