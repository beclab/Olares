...
| 版本 | 发布日期 | 更新日志 |
|:--------|:-------------|:----------|
| [1.04 (下载)](http://cdn.olares.com/common/OlaresOne_BIOS_1.04.zip) | 2026-05-09 | <ul><li>在将 **Primary Display** 设置更改为 **HG** 时添加警告提示。</li><li>通过锁定 GPU PCIe 速度为 Gen4 修复 GPU 意外断开连接的问题。</li><li>通过禁用产品空闲时将 GPU 置于睡眠模式的功能，修复长时间使用后性能下降且功耗异常受限的问题。</li></ul> |
...
| 版本 | 发布日期 | 更新日志 |
|:--------|:-------------|:----------|
| [1.02 (下载)](http://cdn.olares.com/common/OlaresOne_EC_1.02.zip) | 2026-01-19 | <ul><li>修复键盘无法唤醒系统从睡眠模式恢复的问题。</li></ul> |
