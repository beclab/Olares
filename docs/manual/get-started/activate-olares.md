...
<!-- #region activation-wizard-basics -->
...
<!-- #endregion activation-wizard-basics -->
...
<!-- #region activate-with-larepass-intro -->
5. Activate Olares using LarePass app.
<!-- #endregion activate-with-larepass-intro -->

   :::warning Same network required for admin users
   To avoid activation failures, ensure that both your phone and the Olares device are connected to the same network.
   :::
<!-- #region scan-qr-and-reset-password -->
...
<!-- #endregion activation-complete-redirect -->
