...
| `integration` | account list/get/add/delete, `cookie import/list/rm/validate` | [integration credentials and cookies](references/olares-settings-integration.md) |
...
- A download or collection that fails for a missing login is a cookie import here (`settings integration cookie`), not an [`olares-knowledge`](../olares-knowledge/SKILL.md) problem — see [integration credentials and cookies](references/olares-settings-integration.md).
