...
- **My Olares**: View your account profile, manage hardware, check Olares Space, change your password, set network access policies, and view the Olares OS version.
- **Users**: Manage user accounts within your Olares system.
- **Appearance**: Personalize your system language, widgets, date and time format, dashboard visibility, and theme.
