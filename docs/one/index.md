...
Follow the path from first boot to everyday use and advanced customization.
...
<div class="vpath">
  ...
  <div class="vpath-stage">
    ...
    <div class="vpath-body">
      <div class="vpath-title">System update</div>
      <div class="vpath-links">
        <a href="./update">Update OS</a>
        <a href="./factory-reset">Restore Olares One</a>
      </div>
    </div>
  </div>
  <div class="vpath-stage">
    ...
    <div class="vpath-body">
      <div class="vpath-title">Reference</div>
      <div class="vpath-links">
        <a href="./spec">Technical spec</a>
        <a href="./faq">FAQs</a>
