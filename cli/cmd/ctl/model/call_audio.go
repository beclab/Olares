...
Examples:
  olares-cli model call transcribe meeting.m4a
  olares-cli model call transcribe clip.wav --language zh
  olares-cli model call transcribe talk.mp3 --response-format srt > talk.srt
  olares-cli model call transcribe interview.mp3 --translate
`,
...
Examples:
  olares-cli model call speak "your build finished" --out done.mp3
  olares-cli model call speak "hello" --voice alloy --out hello.wav --response-format wav
  echo "read this aloud" | olares-cli model call speak --out out.mp3
  olares-cli model call speak "piped" | ffplay -
`,
