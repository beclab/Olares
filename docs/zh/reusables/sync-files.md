...
2. 输入库名称并点击**创建**。
<!-- #endregion create-sync-library -->

### 开启同步

<!-- #region enable-sync-to-local -->
...
<!-- #endregion enable-sync-to-local -->

### 管理同步

<!-- #region manage-sync-to-local -->
...
<!-- #endregion manage-sync-to-local -->
<!-- #endregion sync-files-to-local -->
