...
:::warning
本文档由 AI 自动翻译，仅供参考。涉及关键操作或信息时，请以[英文原文](../../use-cases/open-notebook-1.12.6.md)为准。
:::

# 使用 Open Notebook 构建研究笔记 — Olares 1.12.6
...
- 以下模型：
  ...
  | TTS | `speaches-ai/Kokoro-82M-v1.0-ONNX` | 从 Market 安装 [Speaches](speaches-1.12.6.md) |
...
- [使用 Engine Base 运行本地模型](llm-base-apps-1.12.6.md)：通过 Ollama 等推理引擎部署模型。
- [Speaches](speaches-1.12.6.md)：设置本地语音转文本和文本转语音服务。
