...
:::warning
本文档由 AI 自动翻译，仅供参考。涉及关键操作或信息时，请以[英文原文](../../use-cases/speaches-1.12.6.md)为准。
:::

# 使用 Speaches 搭建语音服务 — Olares 1.12.6
...
- [Open WebUI](openwebui-1.12.6.md)：可以使用 Speaches 作为语音后端的聊天界面。
