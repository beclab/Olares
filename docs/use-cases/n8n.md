...
:::info Set up NocoDB first
If you have not created a NocoDB base and table yet, follow [Build a self-hosted spreadsheet database with NocoDB](nocodb.md#create-tables-and-import-data), then return here.
:::
