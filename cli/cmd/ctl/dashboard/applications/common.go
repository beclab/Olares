...
// NewApplicationsCommand at construction time; cobra's persistent-flag
...
const (
	...
	KindApplicationsList = pkgdashboard.KindApplicationsList
...
// common is wired by NewApplicationsCommand(f, cf) at construction; reads
