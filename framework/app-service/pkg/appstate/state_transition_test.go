...
func TestIsStateTransitionValid(t *testing.T) {
	cases := []struct {
		...
		{appsv1.ResumeFailed, appsv1.Upgrading, false},
		{appsv1.ResumeFailed, appsv1.ApplyingEnv, true},
		{appsv1.StopFailed, appsv1.Upgrading, false},
...
func TestIsOperationAllowed(t *testing.T) {
	cases := []struct {
		...
		{appsv1.Stopped, appsv1.UpgradeOp, true},
		{appsv1.UpgradeFailed, appsv1.UpgradeOp, true},
		{appsv1.StopFailed, appsv1.UpgradeOp, false},
		{appsv1.ResumeFailed, appsv1.UpgradeOp, false},
		{appsv1.ResumeFailed, appsv1.ApplyEnvOp, true},
		{appsv1.ResumeFailed, appsv1.ResumeOp, true},
		{appsv1.StopFailed, appsv1.StopOp, true},
