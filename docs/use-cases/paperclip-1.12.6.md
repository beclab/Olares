...
# Coordinate multiple AI agents with Paperclip — Olares 1.12.6
...
- [Orchestrate multi-agent workflows with oh-my-openagent](opencode-omo-1.12.6.md): Run multi-agent collaboration inside a single OpenCode instance on Olares.
- [Set up OpenCode as your AI coding agent](opencode-1.12.6.md): Install and configure OpenCode, a common Paperclip adapter.
