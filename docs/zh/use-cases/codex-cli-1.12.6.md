...
:::warning
本文档由 AI 自动翻译，仅供参考。涉及关键操作或信息时，请以[英文原文](../../use-cases/codex-cli-1.12.6.md)为准。
:::

# 在 Olares 上运行 Codex CLI — Olares 1.12.6
...
- [使用 Engine Base 应用托管本地大语言模型](llm-base-apps-1.12.6.md)：通过 Model Console 部署和管理模型。
