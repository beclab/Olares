...
<table>
  <tr>
    <td><img :src="withBase('/images/manual/use-cases/sd-example1.png')" alt="示例图片 1" width="200" /></td>
    <td><img :src="withBase('/images/manual/use-cases/sd-example2.png')" alt="示例图片 2" width="200" /></td>
  </tr>
  <tr>
    <td><img :src="withBase('/images/manual/use-cases/sd-example3.png')" alt="示例图片 3" width="200" /></td>
    <td><img :src="withBase('/images/manual/use-cases/sd-example4.png')" alt="示例图片 4" width="200" /></td>
  </tr>
</table>