...
# Connect an AI app to a model service — Olares 1.12.6
...
- [Build your local AI agent with LobeHub](/use-cases/lobechat-1.12.6.md)
- [Set up Open WebUI for local AI chat](/use-cases/openwebui-1.12.6.md)
- [Customize your local AI assistant using Dify](/use-cases/dify-1.12.6.md)

## Learn more

- [How do AI apps connect on Olares?](../help/usage.md#how-do-ai-apps-connect-on-olares)
- [Run local LLMs with Ollama, vLLM, llama.cpp, and SGLang](../../use-cases/llm-base-apps-1.12.6.md)
