...
# Set up Open WebUI for local AI chat — Olares 1.12.6
...
- [Enable web search](openwebui-search-1.12.6.md): Add web search capabilities to your chats.
- [Use knowledge base](openwebui-knowledge-1.12.6.md): Upload documents and create a knowledge base for RAG.
