...
# Create design files with Open Design — Olares 1.12.6
...
- [Connect AI apps to model services](/manual/best-practices/connect-ai-apps-1.12.6.md): Understand model names, API formats, and Base URLs.
