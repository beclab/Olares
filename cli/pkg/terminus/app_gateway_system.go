...
// ValidateAppGatewaySystemInstaller checks the release bundle before cluster install.
...
// InstallAppGatewaySystem installs the app-gateway-system umbrella chart (Envoy Gateway control
// plane + Gateway/GatewayClass/EnvoyProxy overlay). CRDs are applied separately by ApplyNetworkCRDs.
