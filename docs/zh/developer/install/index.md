...
本章节涵盖你在 Olares 主机上用 `olares-cli` 完成的所有操作：在全新机器上安装 Olares、了解它的文件布局和环境变量、遵循版本规则，以及查阅任意主机模式命令。

- [安装架构](installation-overview.md)：从整体架构和核心组件的角度了解 Olares 的安装。
- [安装流程](installation-process.md)：详解安装流水线的四个主要阶段。
