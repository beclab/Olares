...
先创建自定义域名 Olares ID，再用它激活 Olares。要完成本教程，你需要一台全新设备、已恢复出厂设置的设备，或一台尚未激活过 Olares 的设备。

如果设备已经使用 `olares.cn` 域名的 Olares ID 激活，无法直接改用自定义域名。你需要先[将 Olares 恢复出厂设置](../larepass/manage-olares.md#将-olares-恢复出厂设置)，再重新按照本教程操作。
:::
...
- 一台全新、已恢复出厂设置或尚未激活过的 Olares 设备。如果要复用已激活过的硬件，需要先[将 Olares 恢复出厂设置](../larepass/manage-olares.md#将-olares-恢复出厂设置)，再继续操作。
