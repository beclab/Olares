...
func TestHostRegexValue(t *testing.T) {
	...
	cases := map[string]bool{
		...
		"01234568.alice.olares.com":   false, // wrong hash
		"01234567.alice.example.com":  false, // wrong domain
		"01234567.alice.olares-com":   false,
		"01234567.alice.olares.comm":  false,
