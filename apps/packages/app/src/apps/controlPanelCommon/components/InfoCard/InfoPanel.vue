...
import { _capitalize } from '@apps/control-panel-common/src/utils/index';
import ringWhite from '@apps/control-panel-common/assets/ring-white.svg';
import serverWhite from '@apps/control-panel-common/assets/server-white.svg';
import ringBlue from '@apps/control-panel-common/assets/ring-blue.svg';
import serverBlue from '@apps/control-hub/assets/server-blue.svg';
