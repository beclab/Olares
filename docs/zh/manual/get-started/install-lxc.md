...
:::tip 配置 GPU 直通
如需在 LXC 中使用 GPU，需要在 PVE 中配置 GPU 直通。详细步骤见[在 PVE 中配置 GPU 直通](/zh/manual/best-practices/install-olares-gpu-passthrough.md#在-pve-中配置-gpu-直通)。
:::
