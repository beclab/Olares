...
head:
  - - meta
    - name: keywords
      content: Olares, Vault, 密码管理器, 存储密码, 管理凭据, 安全笔记, 两步验证
---
...
- [共享 Vault 项目](share-vault-items.md)：管理团队 Vault 和共享项目。
- [使用 LarePass 自动填充](../../larepass/autofill.md)：在多设备间自动填充登录信息。
- [设置两步验证码](../../larepass/two-factor-verification.md)：生成并存储 2FA 验证码。