...
func NewCmdAppUpload() *cobra.Command {
...
Examples:
  olares-cli app upload myapp-1.0.0.tgz
  olares-cli app upload ./charts/`,
...
func runUpload(opts *AppOptions, path string) error {
...
func uploadDir(opts *AppOptions, mc *MarketClient, dir, source string) error {
...
func uploadFile(opts *AppOptions, mc *MarketClient, filePath, source string) error {
...
func doUploadFile(opts *AppOptions, mc *MarketClient, filePath, source string) error {
