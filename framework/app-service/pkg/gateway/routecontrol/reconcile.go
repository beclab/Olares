...
// app-service route control. Zero value uses app-gateway/app-gateway/http.
...
// ReconcileSharedRoute applies the HTTPRoute and NetworkPolicy for one SRR.
//
...
//
// requirement (NP-minimal scheme, single NP per upstream namespace):
...
// httpRouteName, observedGeneration). Idempotent when status is unchanged.
