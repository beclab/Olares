...
search: false
outline: [2, 3]
title: Run local AI models with Engine Base apps — Olares 1.12.6
...
# Run local LLMs with Ollama, vLLM, llama.cpp, and SGLang — Olares 1.12.6
...
The following example uses [OpenCode](opencode-1.12.6.md) as the client.
